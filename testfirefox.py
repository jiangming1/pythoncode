...
time.sleep(3)
driver.get("http://192.168.180.18:8080/view/%E7%94%9F%E4%BA%A7%E7%8E%AF%E5%A2%83/job/fj052_mag_prod_deploy/")
driver.find_element_by_class_name("setting-input").send_keys(runtag)
#driver.find_element_by_id("yui-gen1-button").click()
time.sleep(3)
driver.get("http://192.168.180.18:8080/view/%E7%81%BE%E5%A4%87%E7%8E%AF%E5%A2%83/job/fj052_mag_prod_deploy/")
driver.find_element_by_class_name("setting-input").send_keys(runtag)
#driver.find_element_by_id("yui-gen1-button").click()
time.sleep(3)
#yui-gen1-button
