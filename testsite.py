...
time.sleep(9)
driver.get("http://192.168.180.18:8080/view/%E7%94%9F%E4%BA%A7%E7%8E%AF%E5%A2%83/job/fj050_site_prod_deploy/build?delay=0sec")
driver.find_element_by_class_name("setting-input").send_keys(runtag)
driver.find_element_by_id("yui-gen1-button").click()
time.sleep(9)
driver.get("http://192.168.180.18:8080/view/%E7%81%BE%E5%A4%87%E7%8E%AF%E5%A2%83/job/fj050_site_prod_deploy/build?delay=0sec")
driver.find_element_by_class_name("setting-input").send_keys(runtag)
driver.find_element_by_id("yui-gen1-button").click()
time.sleep(9)
driver.quit()